...
public sealed class PaletteCyclingManager : IDisposable
{
    ...
    ///     image caches. Must be called before building tile atlases, since the atlas build uses these images.
    /// </summary>
    ...
    public void Update(int animationTick)
    {
        ...
        //bg path swaps atlas region pointers, zero gpu work
        ...
        //fg path swaps atlas region pointers, zero gpu work
