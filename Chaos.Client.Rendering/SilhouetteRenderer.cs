...
{
    /// <summary>
    ///     Uniform alpha the silhouette overlay is drawn at - how visible blocked entities (player, enemies, NPCs, items)
    ///     are through walls/foreground. Player-configurable: the Client sets this from ClientSettings (Options slider).
    /// </summary>
    public static float SilhouetteAlpha { get; set; } = 0.50f;
