...
public sealed class CreatureRenderer : IDisposable
{
    ...
    //used by overlay positioning to figure out a stable "sprite top" for each creature sprite.
    ...
    ///     positioning to figure out a stable "sprite top" that accounts for frame-to-frame variance without per-frame jitter.
