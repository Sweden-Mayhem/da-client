...
public sealed class LocalPlayerSettingsRepository
{
    ...
    {
        //pre-fill with empties so a missing or partial file can never pass null entries
        //to UITextBox.Text, slot-hotkey dispatch reads MacroTextBoxes[i].Text.Length
