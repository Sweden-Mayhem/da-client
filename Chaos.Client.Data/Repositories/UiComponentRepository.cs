...
public sealed class UiComponentRepository : RepositoryBase
{
    ...
    public ControlPrefabSet? Get(string key)
    {
        ...
        //a corrupt asset just returns null instead of throwing
        catch
        {
            return null;
        }
    ...
    /// <summary>
    ///     Figures out which GUI palette number to use for a given EPF image name, based on filename prefix matching.
    /// </summary>
    /// <remarks>
    ///     The prefix-to-palette mapping comes from ChaosAssetManager's RenderUtil setoa dispatch table.
    /// </remarks>
    ...
    /// <summary>
    ///     Loads a single EPF frame from Legend.dat rendered with the Legend palette.
    /// </summary>
    ...
    /// <summary>
    ///     Returns the GUI palette for the given EPF filename, picked by prefix matching.
    /// </summary>
