...
public sealed class MetaFileRepository
{
    ...
    ///     variants are appended after them. Cached after the first call since the data only changes on startup.
    /// </summary>
    ...
    //a corrupt asset just reports failure instead of throwing
