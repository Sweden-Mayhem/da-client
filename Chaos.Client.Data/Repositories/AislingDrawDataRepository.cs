...
public sealed class AislingDrawDataRepository
{
    ...
    public AislingDrawDataRepository()
    {
        ...
        //cache the default (undyed) colors, entry 0 holds the placeholder colors at palette slots 98-103
    ...
    /// <summary>
    ///     Loads an equipment EPF file from the Khan archive picked by type letter and gender.
    /// </summary>
