...
public sealed class SpellBook
{
    ...
    /// <summary>Seconds of cooldown left on a 1-based slot (0 = ready). CooldownRemaining is stored in ms.</summary>
    public float GetCooldownRemainingSeconds(byte slot)
    {
        var index = slot - 1;
        ...
        return CooldownRemaining[index] > 0 ? CooldownRemaining[index] / 1000f : 0f;
    }
        ...
        string[]? Chants)
    {
        ...
        ///     occupation is figured out by the presence of a name instead, cleared slots have <c>Name == null</c>.
        /// </summary>
