...
{
    //60 matches the inventory window's 5x12 grid exactly
    //a 59-slot panel would leave the corner cell permanently dead
        ...
        int currentDurability)
    {
        ...
        //store the clean item name, the stack count is shown on the slot itself and is NOT baked into the name
        //a suffixed name would also break the item metadata lookup, which is keyed by the real item name
