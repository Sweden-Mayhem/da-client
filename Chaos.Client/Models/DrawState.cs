...
/// <summary>
///     Per-frame, render-oriented state computed once by <see cref="Chaos.Client.Screens.WorldScreen" />.Update and used
///     by Draw and overlay systems. This centralizes transient computed state (hover, sort order, tile under cursor) so
