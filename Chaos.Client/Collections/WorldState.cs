...
/// <summary>
///     Tracks all visible entities in the current map and makes available all authoritative game state (inventory, skills, spells,
...
public static class WorldState
{
    ...
    /// <summary>
    ///     The player's guild name, or empty if not in a guild. Set from the SelfProfile packet (fetched on demand, so this
    ///     fills in the first time the profile/group panel is opened). Drives whether the chat window shows a Guild tab.
    /// </summary>
    ...
    /// <summary>
    ///     Computed per-frame state (sort order, hover, tile under cursor) filled only by
