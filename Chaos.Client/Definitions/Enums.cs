...
{
    /// <summary>Wire slots 1 to 35.</summary>
    Page1 = 0,

    /// <summary>Wire slots 37 to 71 (Shift+S / Shift+D alt panels).</summary>
    Page2 = 36,

    /// <summary>Wire slots 73 to 88 (skills) / 73 to 89 (spells). World abilities shown on the H tab.</summary>
    Page3 = 72
}
...
/// <summary>
///     Figures out which icon variant to display for an ability in the metadata tab.
/// </summary>
