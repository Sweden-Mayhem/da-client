...
public sealed class AbilityMetadataDetailsControl : PrefabPanel
{
    ...
    /// <summary>
    ///     Populates and shows the detail view for the given ability entry. Placement + magnification are owned by the
    ///     wrapping ScaleHost (centered + scaled by "Window size" on show), so this just fills in and shows the content.
    /// </summary>
    public void ShowEntry(AbilityMetadataEntry entry)
    {
