...
public sealed class SelfProfileEventMetadataTab : PrefabPanel
{
    ...
    {
        //completed when the player has a legend mark whose key matches this event's id
        ...
        //figure out the player's circle from level, master flag forces circle 6
        ...
        //check qualifying circles, the player's circle must be in the list
        ...
        //check qualifying classes, the player's class must be in the list
        ...
        //check prerequisite event, it must be completed
        ...
        bool enableMasterQuests)
    {
        ...
        //spread events across display slots, sevent page maps to slot = min(page - 1, 5)
