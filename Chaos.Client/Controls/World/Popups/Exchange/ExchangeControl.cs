...
public sealed class ExchangeControl : PrefabPanel
{
        ...
        : base("_nexch")
    {
        ...
        if (OkButton is not null)
        {
            ...
            OkButton.Tooltip = "Accept\nConfirm the trade. Both players must accept before the items and gold change hands. Check the offer carefully first.";
        }

        if (CancelButton is not null)
        {
            CancelButton.Clicked += () => OnCancel?.Invoke();
            CancelButton.Tooltip = "Cancel\nCall off the trade. Nothing changes hands.";
        }
        ...
        //vertical scrollbars on the right edge of each exchange rect
        ...
        //horizontal scrollbars on the bottom edge of each exchange rect
    ...
    public override void OnMouseScroll(MouseScrollEvent e)
    {
        ...
        //figure out which exchange rect the mouse is over
