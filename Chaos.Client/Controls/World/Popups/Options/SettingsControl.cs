...
///     Number buttons from _nsettb.spf (2 frames per setting: normal, pressed). Layout based on TopButton/TopText/
...
public sealed class SettingsControl : PrefabPanel
{
        ...
        : base("_nsett", false)
    {
        ...
        //default names for client-local settings (server settings filled via sendoptiontoggle(request))
