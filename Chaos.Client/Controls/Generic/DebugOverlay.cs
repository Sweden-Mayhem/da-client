...
public static class DebugOverlay
{
    ...
    public static void DrawElement(SpriteBatchEx spriteBatch, UIElement element)
    {
        ...
        {
            InfoHotspot => Color.Orange, //invisible hover regions over baked art, drawn here so they can be placed
            UIButton    => Color.Lime,
    ...
    private static void DrawPerformanceStatsText(SpriteBatchEx spriteBatch)
    {
        ...
        //line 0, FPS plus frame time (0.05ms tolerance matches {ms:F1} display precision)
        ...
        //line 3, heap plus gc mode (0.05 MB tolerance matches {heapMb:F1} display precision)
