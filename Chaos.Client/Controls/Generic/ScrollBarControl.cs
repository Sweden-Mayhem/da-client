...
public sealed class ScrollBarControl : UIElement
{
    ...
    //scroll.epf frame order is left(0,1), right(2,3), up(4,5), down(6,7), thumb(8), track(9)
    //each pair is [normal, active]
    ...
    /// <summary>Uniform draw opacity (1 = opaque). Lets a fading host (e.g. the chat window) fade the scrollbar too.</summary>
