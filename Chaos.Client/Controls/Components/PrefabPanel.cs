...
public abstract class PrefabPanel : UIPanel
{
    ...
    protected PrefabPanel(string prefabName, bool center = true)
    {
        ...
        //anchor holds the panel dimensions and background
    ...
    private T? CreateButtonFromPrefab<T>(ControlPrefab prefab) where T : UIButton, new()
    {
        ...
        //standard layout (_nbtn, etc) has 3 frames per button as [normal, pressed, disabled].
        //exception: _ncarrow (angle and hair arrow buttons) packs all normals together followed by
